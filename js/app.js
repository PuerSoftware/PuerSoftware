(() => {
    ...
    class Animate {
        ...
        advance(t) {
            ...
            }(this.value, this.to, 60 * this.lerp, t), Math.round(this.value) === this.to && (this.value = this.to, 
            e = !0)) : (this.value = this.to, e = !0);
    ...
    class Dimensions {
        constructor(t, i, {autoResize: e = !0, debounce: s = 250} = {}) {
            this.wrapper = t, this.content = i, this.width = 0, this.height = 0, this.scrollHeight = 0, 
            this.scrollWidth = 0, this.resize = () => {
                this.onWrapperResize(), this.onContentResize();
            }, this.onWrapperResize = () => {
                this.wrapper instanceof Window ? (this.width = window.innerWidth, this.height = window.innerHeight) : (this.width = this.wrapper.clientWidth, 
            ...
            }(this.resize, s), this.wrapper instanceof Window ? window.addEventListener("resize", this.debouncedResize, !1) : (this.wrapperResizeObserver = new ResizeObserver(this.debouncedResize), 
        ...
        destroy() {
            var t, i;
            null === (t = this.wrapperResizeObserver) || void 0 === t || t.disconnect(), null === (i = this.contentResizeObserver) || void 0 === i || i.disconnect(), 
    ...
    class VirtualScroll {
        constructor(e, s = {
            ...
            this.element = e, this.options = s, this.touchStart = {
                ...
                e *= 1 === o ? t : 2 === o ? this.window.width : 1, s *= 1 === o ? t : 2 === o ? this.window.height : 1, 
                e *= this.options.wheelMultiplier, s *= this.options.wheelMultiplier, this.emitter.emit("scroll", {
                    deltaX: e,
                    deltaY: s,
                    event: i
                });
            ...
            this.element.addEventListener("wheel", this.onWheel, i), this.element.addEventListener("touchstart", this.onTouchStart, i), 
            this.element.addEventListener("touchmove", this.onTouchMove, i), this.element.addEventListener("touchend", this.onTouchEnd, i);
        }
        on(t, i) {
        ...
        destroy() {
            ...
            this.element.removeEventListener("wheel", this.onWheel, i), this.element.removeEventListener("touchstart", this.onTouchStart, i), 
            this.element.removeEventListener("touchmove", this.onTouchMove, i), this.element.removeEventListener("touchend", this.onTouchEnd, i);
        }
    }
    class Lenis {
        constructor({wrapper: t = window, content: i = document.documentElement, eventsTarget: e = t, smoothWheel: s = !0, syncTouch: o = !1, syncTouchLerp: n = .075, touchInertiaMultiplier: l = 35, duration: r, easing: h = t => Math.min(1, 1.001 - Math.pow(2, -10 * t)), lerp: a = .1, infinite: c = !1, orientation: u = "vertical", gestureOrientation: d = "vertical", touchMultiplier: p = 1, wheelMultiplier: m = 1, autoResize: v = !0, prevent: g, virtualScroll: S, __experimental__naiveDimensions: w = !1} = {}) {
            this._isScrolling = !1, this._isStopped = !1, this._isLocked = !1, this._preventNextNativeScrollEvent = !1, 
            this._resetVelocityTimeout = null, this.time = 0, this.userData = {}, this.lastVelocity = 0, 
            this.velocity = 0, this.direction = 0, this.animate = new Animate, this.emitter = new Emitter, 
            this.onPointerDown = t => {
                ...
                if (!(this.options.syncTouch && o || this.options.smoothWheel && n)) return this.isScrolling = "native", 
                ...
                this._resetVelocityTimeout = null), this._preventNextNativeScrollEvent) this._preventNextNativeScrollEvent = !1; else if (!1 === this.isScrolling || "native" === this.isScrolling) {
                    const t = this.animatedScroll;
                    this.animatedScroll = this.targetScroll = this.actualScroll, this.lastVelocity = this.velocity, 
                    this.velocity = this.animatedScroll - t, this.direction = Math.sign(this.animatedScroll - t), 
                    this.isScrolling = "native", this.emit(), 0 !== this.velocity && (this._resetVelocityTimeout = setTimeout((() => {
                        this.lastVelocity = this.velocity, this.velocity = 0, this.isScrolling = !1, this.emit();
                    }), 400));
                }
            }, window.lenisVersion = "1.1.13", t && t !== document.documentElement && t !== document.body || (t = window), 
            this.options = {
                wrapper: t,
                content: i,
                eventsTarget: e,
            ...
            this.options.wrapper.addEventListener("scroll", this.onNativeScroll, !1), this.options.wrapper.addEventListener("pointerdown", this.onPointerDown, !1), 
        ...
        destroy() {
            ...
            this.virtualScroll.destroy(), this.dimensions.destroy(), this.cleanUpClassName();
        }
        on(t, i) {
            return this.emitter.on(t, i);
        }
        ...
        resize() {
            this.dimensions.resize(), this.animatedScroll = this.targetScroll = this.actualScroll, 
            this.emit();
        }
        emit() {
        ...
        scrollTo(t, {offset: i = 0, immediate: e = !1, lock: s = !1, duration: o = this.options.duration, easing: n = this.options.easing, lerp: l = this.options.lerp, onStart: r, onComplete: h, force: a = !1, programmatic: c = !0, userData: u} = {}) {
            if (!this.isStopped && !this.isLocked || a) {
                ...
                if ("number" == typeof t) {
                    if (t += i, t = Math.round(t), this.options.infinite ? c && (this.targetScroll = this.animatedScroll = this.scroll) : t = clamp(0, t, this.limit), 
                    t === this.targetScroll) return null == r || r(this), void (null == h || h(this));
                    if (this.userData = null != u ? u : {}, e) return this.animatedScroll = this.targetScroll = t, 
                    this.setScroll(this.scroll), this.reset(), this.preventNextNativeScrollEvent(), 
                    this.emit(), null == h || h(this), void (this.userData = {});
                    c || (this.targetScroll = t), this.animate.fromTo(this.animatedScroll, t, {
                        ...
                        onUpdate: (t, i) => {
                            this.isScrolling = "smooth", this.lastVelocity = this.velocity, this.velocity = t - this.animatedScroll, 
                            this.direction = Math.sign(this.velocity), this.animatedScroll = t, this.setScroll(this.scroll), 
                            c && (this.targetScroll = t), i || this.emit(), i && (this.reset(), this.emit(), 
                            null == h || h(this), this.userData = {}, this.preventNextNativeScrollEvent());
                        }
                    });
                }
            }
        ...
        get className() {
            ...
            this.isScrolling && (t += " lenis-scrolling"), "smooth" === this.isScrolling && (t += " lenis-smooth"), 
            t;
        }
        updateClassName() {
...
*/
    ...
    Math.sin), paths_cos = Math.cos, paths_abs = Math.abs, paths_sqrt = Math.sqrt, paths_isNumber = (Math.atan2, 
...
*/
    ...
    gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger, CustomEase);
    CustomEase.create("primary-ease", "0.62, 0.05, 0.01, 0.99");
    CustomEase.create("secondary-ease", "0.25, 0.74, 0.22, 0.99");
    ...
    gsapWithCSS.from(".hero__code-inner", {
        yPercent: 110,
        duration: durationDefaultMiddle,
        delay: .6,
        ease: "secondary-ease",
    ...
    gsapWithCSS.from(".hero__partner-inner", {
        y: 110,
        duration: durationDefaultMiddle,
        ease: "secondary-ease",
        stagger: .1,
        scrollTrigger: {
            trigger: ".hero__partner-wrapper",
            start: "top 90%"
        }
    });
    gsapWithCSS.utils.toArray(".section-inner").forEach((sectionInner => {
        gsapWithCSS.from(sectionInner, {
            opacity: 0,
            duration: durationDefaultMiddle,
            ease: "linear",
            scrollTrigger: {
    ...
    gsapWithCSS.utils.toArray(".offers__item-icon").forEach((offerIcon => {
        gsapWithCSS.from(offerIcon, {
            scaleY: 0,
            duration: durationDefaultMiddle,
            ease: "secondary-ease",
            scrollTrigger: {
    ...
    gsapWithCSS.utils.toArray(".about__item").forEach((aboutItem => {
        const aboutItemIcon = aboutItem.querySelector(".about__item-icon");
        const aboutItemText = aboutItem.querySelector(".about__item-textbox");
        gsapWithCSS.from([ aboutItemIcon, aboutItemText ], {
            opacity: 0,
            x: 100,
            ease: "secondary-ease",
    ...
    gsapWithCSS.utils.toArray(".team__item-stepmarker-inner").forEach((progressMarker => {
        gsapWithCSS.to(progressMarker, {
            scale: 1,
    ...
    gsapWithCSS.utils.toArray(".team__item-line").forEach((progressLine => {
        const container = progressLine.closest(".team__item-line-container");
        gsapWithCSS.to(progressLine, {
            height: "100%",
            scrollTrigger: {
                trigger: container,
                start: "top center",
    ...
    gsapWithCSS.utils.toArray(".team__item-content").forEach((teamMember => {
        gsapWithCSS.to(teamMember, {
            opacity: 1,
            ease: "primary-ease",
            duration: .3,
            scrollTrigger: {
    ...
    function splitTextIntoLines(sourceTextBlock) {
        const initialWidth = sourceTextBlock.offsetWidth;
        const text = sourceTextBlock.textContent;
        const words = text.split(" ");
        const tempSpan = document.createElement("span");
        let line = "";
        let spans = [];
        sourceTextBlock.innerHTML = "";
        tempSpan.style.visibility = "hidden";
        tempSpan.style.position = "absolute";
        tempSpan.style.whiteSpace = "nowrap";
        tempSpan.style.font = window.getComputedStyle(sourceTextBlock).font;
        document.body.appendChild(tempSpan);
        function createOuterSpan(content) {
            const span = document.createElement("span");
            span.className = "text-wrapper";
            span.appendChild(createInnerSpan(content));
            return span;
        }
        function createInnerSpan(content) {
            const span = document.createElement("span");
            span.className = "text-anim text-inner";
            span.textContent = content;
            return span;
        }
        for (let word of words) {
            tempSpan.textContent = line + (line ? " " : "") + word;
            if (tempSpan.scrollWidth > initialWidth) {
                line && spans.push(createOuterSpan(line));
                line = word;
            } else line += (line ? " " : "") + word;
        }
        line && spans.push(createOuterSpan(line));
        spans.forEach((span => sourceTextBlock.appendChild(span)));
        document.body.removeChild(tempSpan);
    }
    function animateTextLine() {
        gsapWithCSS.utils.toArray(".text-anim").forEach((textLine => {
            gsapWithCSS.from(textLine, {
                yPercent: 110,
                duration: 1.47,
                ease: "primary-ease",
                scrollTrigger: {
    ...
    window.addEventListener("load", (() => {
        subtitles.forEach((subtitle => {
            splitTextIntoLines(subtitle);
        }));
        animateTextLine();
        scrollToTop();
    }));
    window.addEventListener("resize", reloadOnOrientationChange);
